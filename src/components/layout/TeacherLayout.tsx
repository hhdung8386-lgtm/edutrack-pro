...
export function TeacherLayout() {
  ...
  return (
    <div className="min-h-screen bg-slate-900">
      {/* Desktop header */}
      <header className="hidden lg:flex fixed top-0 left-0 right-0 h-16 bg-slate-900 border-b border-slate-800 items-center px-6 z-30 gap-4">
        <div className="flex items-center gap-2.5 flex-1">
          <div className="w-8 h-8 bg-indigo-500 rounded-lg flex items-center justify-center">
            <GraduationCap className="w-4.5 h-4.5 text-white" />
          </div>
          <span className="font-bold text-white">EduTrack Pro</span>
      ...
      {/* Mobile header */}
      <header className="lg:hidden fixed top-0 left-0 right-0 h-14 bg-slate-900 border-b border-slate-800 flex items-center px-4 z-40">
        <div className="flex items-center gap-2">
          <div className="w-7 h-7 bg-indigo-500 rounded-lg flex items-center justify-center">
            <GraduationCap className="w-4 h-4 text-white" />
          </div>
          <span className="font-semibold text-slate-100 text-sm">EduTrack Pro</span>
        </div>
      </header>
