    ...
    blocks: [
      {
        ...
        type: 'hero',
        enabled: true,
        eyebrow: 'Đội ngũ giáo viên tâm huyết & chuyên nghiệp',
        title: 'Nâng tầm\nchất lượng giáo dục',
        subtitle:
          'Giáo viên 123English luôn biết cách khơi gợi sự tò mò và xây dựng sự tự tin cho học viên. Với bề dày kinh nghiệm và lòng yêu nghề, thầy cô giúp học viên tận hưởng niềm vui học tập và giao tiếp tiếng Anh một cách tự nhiên, trôi chảy.',
      ...
      },
      {
        ...
        type: 'featureList',
        enabled: true,
        eyebrow: 'Chỉ 3% ứng viên trở thành giáo viên của 123English',
      ...
      },
      {
        ...
        type: 'featureList',
        enabled: true,
        title: 'Luôn duy trì chất lượng giáo viên xuất sắc',
        image: '/home-quality-review-2026.png',
        imagePosition: 'right',
        items: [
          { id: 'gr-1', title: 'Dự giờ & kiểm định lớp học', description: 'Đội ngũ chuyên môn kiểm tra ngẫu nhiên các lớp học trực tuyến để đảm bảo chất lượng giảng dạy của giáo viên.' },
          ...
          { id: 'gr-3', title: 'Nâng cao chuyên môn', description: 'Giáo viên tham gia các khoá đào tạo hằng tháng để cập nhật phương pháp mới và hoàn thiện kỹ năng giảng dạy.' },
        ],
      },
      {
        id: 'home-global',
        type: 'imageText',
        enabled: true,
        title: 'Đội ngũ giáo viên quốc tế thấu hiểu tâm lý trẻ',
        body:
          'Với đội ngũ giáo viên đến từ Việt Nam, Philippines và nhiều quốc gia khác, 123English mang đến những giáo viên không chỉ giỏi chuyên môn mà còn am hiểu đa văn hoá. Thầy cô luôn biết cách kết nối và điều chỉnh phương pháp dạy phù hợp nhất với tính cách của mỗi học viên.',
      ...
      },
      {
        ...
        type: 'imageText',
        enabled: true,
        title: 'Hơn cả giáo viên — là người bạn đồng hành',
        body:
          'Tại 123English, giáo viên không chỉ truyền tải kiến thức mà còn xây dựng niềm tin, khích lệ và trở thành người bạn đồng hành thực thụ trên hành trình học tập của con. Từ những bước đầu tiên đến các khoảnh khắc bứt phá, thầy cô luôn ở đó để truyền động lực, hỗ trợ và cùng con ăn mừng mỗi bước tiến mới.',
