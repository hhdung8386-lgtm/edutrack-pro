...
/**
 * Hồ sơ được phép công khai cho phụ huynh.
 *
 * Đây là một DTO whitelist độc lập. Tuyệt đối không thêm các trường tài khoản,
 * ngân hàng, đơn giá hay dữ liệu vận hành nội bộ vào kiểu dữ liệu này.
 */
...
/**
 * Tạo đúng payload an toàn để ghi vào `publicTeacherProfiles/{teacherId}`.
 * Hàm cố ý liệt kê từng trường và không sao chép nguyên bản ghi Teacher.
 */
