...
const translations: Record<string, Record<Lang, string>> = {
  ...
  'report.homework_content': { vi: 'Nội dung giao', en: 'Assigned content' },
  'report.homework_placeholder': { vi: 'VD: Hoàn thành Workbook trang 12–13 (bài 1–3), ôn lại 8 từ vựng đã học và luyện đọc mẫu câu "What color is it?" – "It is…" ít nhất 5 lần.', en: 'E.g., Complete Workbook pages 12–13 (ex. 1–3), review the 8 vocabulary words and practice "What color is it?" – "It is…" at least 5 times.' },
