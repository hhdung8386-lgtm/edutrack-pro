...
const translations: Record<string, Record<Lang, string>> = {
  ...
  'avail.announcement_p1': { vi: 'Hiện tại một số giáo viên tạm thời không thể điểm danh do chưa cập nhật lịch rảnh trên Platform.', en: 'Currently, some teachers are temporarily unable to take attendance because they have not updated their availability on the Platform.' },
  'avail.announcement_p2': { vi: 'Giáo viên vui lòng cập nhật lịch rảnh. Sau khi cập nhật thành công, hệ thống sẽ tự động mở lại quyền điểm danh.', en: 'Please update your availability. After a successful update, the system will automatically restore your attendance privileges.' },
  ...
  'parent.modal_teacher': { vi: 'Giáo viên', en: 'Teacher' },
